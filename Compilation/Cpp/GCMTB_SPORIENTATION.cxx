...
{
	GCMTB_SPORIENTATION *pPanel = (GCMTB_SPORIENTATION*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCMTB_SPORIENTATION( GBaseObject *pObject )
{
	GCMTB_SPORIENTATION *pPanel = new GCMTB_SPORIENTATION;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCMTB_SPORIENTATION;
 ...
 *	<description>	:	コンストラクタ
 */
GCMTB_SPORIENTATION::GCMTB_SPORIENTATION()
{
}
...
#include "GCMTB_SPORIENTATION.prc"

short GCMTB_SPORIENTATION::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCMTB_SPORIENTATION::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
...
long GCMTB_SPORIENTATION::DATAOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor=0;
	SetColor(Cursor);
	ucChkStatus=0;
...
long GCMTB_SPORIENTATION::DATAOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCMTB_SPORIENTATION::DATAOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
void GCMTB_SPORIENTATION::SetColor(short cur_pos)
{
...
void GCMTB_SPORIENTATION::SetData(short cur_pos)
{
...
void GCMTB_SPORIENTATION::ScreenTransition(short ScreenNo)
{
...
long GCMTB_SPORIENTATION::BTNHOMEOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(MTB_PASSWORD);
	return TRUE;
}
long GCMTB_SPORIENTATION::GetEditKeyProtection()
{
...
void GCMTB_SPORIENTATION::SetProximity()
{
	GBaseObject *pChkBox;
	unsigned char ucChkStatusProxi;
	pChkBox = GCSGetChild(GetGBaseObject(), CHKBOX2);
	ucChkStatusProxi=GCSCheckboxGetStatus(pChkBox);

	unsigned long ldata7=0,ldata8=0;
	melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), 97, 106 ,1, (void *)&ldata7, T_LONG);
	melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), 98,  1227 ,1, (void *)&ldata8, T_LONG);
	if(ucChkStatusProxi==0)
	{
	ldata7=ldata7|0x8000/*32768*/;
	ldata8=ldata8|0x4000/*16384*/;
	melSetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)),  97,106,1, (void *)&ldata7, T_LONG);
	melSetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)),  98,1227,1, (void *)&ldata8, T_LONG);
	}
	if(ucChkStatusProxi==1)
	{
	ldata7=ldata7&0x7FFF/*32767*/;
	ldata8=ldata8&0xBFFF/*49151*/;
	melSetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)),  97,106,1, (void *)&ldata7, T_LONG);
	melSetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)),  98,1227,1, (void *)&ldata8, T_LONG);
	}
...
void GCMTB_SPORIENTATION:: ClearWarningMessage()
{
	GBaseObject *pLbl;
	pLbl = GCSGetChild(GetGBaseObject(), MSGBOX);
...
void  GCMTB_SPORIENTATION::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
	GTCHAR szText[WARNTEXT_SIZE];
	...
	if(warnnum == 1)
		...
		GRCMultiByteToUnicode(GRCLoadNowLanguageStr(), szText, "Data does not updated succesfully", sizeof(szText)/sizeof(GTCHAR));
...
void GCMTB_SPORIENTATION:: SetRange(int ScreenNo,short cur_pos)
...
long GCMTB_SPORIENTATION::checkRange(char *dat,int ScreenNo, int cur_pos)
{
//	GBaseObject *pErr;
...
void GCMTB_SPORIENTATION::GetProximity()
{
		GBaseObject *pChkBox;
	pChkBox = GCSGetChild(GetGBaseObject(), CHKBOX2);
	unsigned char ucChkStatusProxi;
	long ldata7=0,ldata8=0;

	melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), 97, 106 ,1, (void *)&ldata7, T_LONG);
	melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), 98,  1227 ,1, (void *)&ldata8, T_LONG);
	//bool a=((ldata7>>15)&1);
	//bool b=((ldata8>>14)&1);
	ucChkStatusProxi=((ldata7>>15)&1)&((ldata8>>14)&1);
	
	GCSCheckboxSetStatus(pChkBox,ucChkStatusProxi);
...
long GCMTB_SPORIENTATION::BTNAXISOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(MTB_AXIS);
	return TRUE;
}

long GCMTB_SPORIENTATION::BTNPROXIMOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetProximity();
	return TRUE;
}

long GCMTB_SPORIENTATION::BTNSPSPEEDOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(MTB_SPSPEED);
	return TRUE;
}
long GCMTB_SPORIENTATION::BTNENABLEOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
...
void GCMTB_SPORIENTATION::StoreData()
{
	...
	//	pTxtB[1] = GCSGetChild(pPanel, TXT2);
		...
		pTxtB[5] = GCSGetChild(pPanel, TXT6);*/
			...
			long TempData=atoi(cInputData),Cmpdata=0,lBitdata;
				melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), M_SEC_PLC_DEV_WORD,M_SSEC_PLWRD_R_1SHOT_EXT(28624+i) ,0, (void *)&Cmpdata, T_LONG);
			if(TempData!=Cmpdata)
			melSetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)),
						   M_SEC_PLC_DEV_WORD,M_SSEC_PLWRD_R_1SHOT_EXT(28624+i),0, &TempData, T_LONG);
			
			//bit enabling
			melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), M_SEC_PLC_DEV_WORD,M_SSEC_PLWRD_R_1SHOT_EXT(28625+i) ,0, (void *)&Cmpdata, T_LONG);
			melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), 97,106 ,1, (void *)&lBitdata, T_LONG);
			
			TempData=lBitdata>>15;
			if(TempData!=Cmpdata)
			{
			if(TempData!=0)
				TempData=1;
			melSetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)),
						   M_SEC_PLC_DEV_WORD,M_SSEC_PLWRD_R_1SHOT_EXT(28625+i),0, &TempData, T_LONG);
			}

			melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), M_SEC_PLC_DEV_WORD,M_SSEC_PLWRD_R_1SHOT_EXT(28626+i) ,0, (void *)&Cmpdata, T_LONG);
			melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), 98,1227 ,1, (void *)&lBitdata, T_LONG);
			TempData=lBitdata>>14;
			if(TempData!=Cmpdata)
			melSetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)),
						   M_SEC_PLC_DEV_WORD,M_SSEC_PLWRD_R_1SHOT_EXT(28626+i),0, &TempData, T_LONG);
...
long GCMTB_SPORIENTATION::CHKBOX1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
		GBaseObject *pChkBox;
	pChkBox = GCSGetChild(GetGBaseObject(), CHKBOX1);
	ucChkStatus=!ucChkStatus;
...
long GCMTB_SPORIENTATION::CHKBOX2OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetProximity();
	return TRUE;
}
