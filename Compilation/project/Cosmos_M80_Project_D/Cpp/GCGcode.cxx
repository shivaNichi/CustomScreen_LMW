...
long GCGcode::KEY_ACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCGcode::KEY_ACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
...
long GCGcode::KEY_ACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	pChild = GCSGetChild(GetGBaseObject(), KEY_ACTION);
...
long GCGcode::KEY_BACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCGcode::KEY_CALC_WINDOWOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	if(!bCalcWindowOpened){
		DisableButtonName();
		bCalcWindowOpened = true;
...
long GCGcode::KEY_CUT_O_METEROnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	sParentScreen = GCODE_SCREEN;
	ScreenTransition(CUT_O_METER_SCREEN);
	return TRUE;
...
long GCGcode::KEY_CYCLESOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetWarningMessage(UNDER_DEVELOPMENT_ERROR);
	return TRUE;
}

long GCGcode::KEY_MACHINING_CONDOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	//ScreenTransition(MACHINE_COND_SELECTION_SCREEN);
	return TRUE;
}

long GCGcode::KEY_MCODEOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(MCODE_SCREEN);
	return TRUE;
}

long GCGcode::KEY_PARAMETEROnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(CUTTING_PARAMETERS_SCREEN);
	return TRUE;
}

long GCGcode::KEY_TOOLDATAOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(MAGAZINE_LIST_SCREEN);
	return TRUE;
}
...
/****************************************************************************************************/
void GCGcode::SetCursor(short cur_pos)
{
...
/****************************************************************************************************/
void GCGcode::ClearWarningMessage()
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCGcode::DisableButtonName()
{
	GBaseObject *pKeyButton[10];

	pKeyButton[0] = GCSGetChild(GetGBaseObject(), KEY_MCODE);
...
/************************************************************************************/
long GCGcode::User(long lLParam, long lUParam)
{
	switch(lLParam)
	{
...
void GCGcode::EnableButtonName()
{
	...
	GCSButtonSetStringID(pKeyButton[0], ID_STRING00229);
...
/*******************************************************************************************/
void GCGcode::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
