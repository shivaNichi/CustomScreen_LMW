...
{
	GCInput2 *pPanel = (GCInput2*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCInput2( GBaseObject *pObject )
{
	GCInput2 *pPanel = new GCInput2;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCInput2;
...
#include "GCInput2.prc"

short GCInput2::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCInput2::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
...
long GCInput2::KEYACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCInput2::KEYACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
...
long GCInput2::KEYACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	pChild = GCSGetChild(GetGBaseObject(), KEYACTION);
...
long GCInput2::KEYBACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(DIAGNOSIS_SCREEN);
	return TRUE;
}

long GCInput2::KEY_CIRCUITSOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetWarningMessage(UNDER_DEVELOPMENT_ERROR);
	return TRUE;
}

long GCInput2::KEY_CUT_O_METEROnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	sParentScreen = INPUT_2_SCREEN;
	ScreenTransition(CUT_O_METER_SCREEN);
	return TRUE;
...
long GCInput2::KEY_HISTORYOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetWarningMessage(UNDER_DEVELOPMENT_ERROR);
	return TRUE;
}

long GCInput2::KEY_INPUT1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(INPUT_1_SCREEN);
	return TRUE;
}

long GCInput2::KEY_NEXTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(OUTPUT_1_SCREEN);
	return TRUE;
}

long GCInput2::KEY_OUTPUTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(OUTPUT_1_SCREEN);
	return TRUE;
}

long GCInput2::KEY_PLC_BITSOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	//ScreenTransition(BITS_1_SCREEN);
	return TRUE;
}

long GCInput2::KEY_VERSIONOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(VERSION_1_SCREEN);
	return TRUE;
}
...
/****************************************************************************************************/
void GCInput2::ClearWarningMessage()
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCInput2::ScreenTransition(short ScreenNo)
{
...
/*******************************************************************************************/
void GCInput2::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
