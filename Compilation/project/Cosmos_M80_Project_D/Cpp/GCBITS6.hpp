#if !defined _GCBITS6_HPP_
#define _GCBITS6_HPP_
#include "genifa.h"
#include "GWin.h"
#include "GCPanel.hpp"
...
public:
	...
	long MSGBOXOnCreate(unsigned short usMessage, long lLParam, long lUParam );
	long MSGBOXOnKeyPress(unsigned short usMessage, long lLParam, long lUParam );
	long MSGBOXOnTimer(unsigned short usMessage, long lLParam, long lUParam );
