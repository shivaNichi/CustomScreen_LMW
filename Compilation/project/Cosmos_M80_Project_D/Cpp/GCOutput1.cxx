...
{
	GCOutput1 *pPanel = (GCOutput1*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCOutput1( GBaseObject *pObject )
{
	GCOutput1 *pPanel = new GCOutput1;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCOutput1;
...
#include "GCOutput1.prc"

short GCOutput1::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCOutput1::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
...
long GCOutput1::KEYACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCOutput1::KEYACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
	...
	case GK_F1:
		...
		ScreenTransition(OUTPUT_2_SCREEN);
		break;
	case GK_F2:
		if(!(((lUParam & KEY_SHIFT) != KEY_SHIFT) && ((lUParam & KEY_SEC) != KEY_SEC)))
	    {
...
long GCOutput1::KEYACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	pChild = GCSGetChild(GetGBaseObject(), KEYACTION);
...
long GCOutput1::KEY_BACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(DIAGNOSIS_SCREEN);
	return TRUE;
}

long GCOutput1::KEY_CIRCUTISOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetWarningMessage(UNDER_DEVELOPMENT_ERROR);
	return TRUE;
}

long GCOutput1::KEY_CUT_O_METEROnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	sParentScreen = OUTPUT_1_SCREEN;
	ScreenTransition(CUT_O_METER_SCREEN);
	return TRUE;
...
long GCOutput1::KEY_HISTORYOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetWarningMessage(UNDER_DEVELOPMENT_ERROR);
	return TRUE;
}

long GCOutput1::KEY_INPUTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(INPUT_1_SCREEN);
	return TRUE;
}

long GCOutput1::KEY_NEXTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(OUTPUT_2_SCREEN);
	return TRUE;
}

long GCOutput1::KEY_OUTPUT2OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(OUTPUT_2_SCREEN);
	return TRUE;
}

long GCOutput1::KEY_PLC_BITSOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	//ScreenTransition(BITS_1_SCREEN);
	return TRUE;
}

long GCOutput1::KEY_VERSIONOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(VERSION_1_SCREEN);
	return TRUE;
}
...
/****************************************************************************************************/
void GCOutput1::ClearWarningMessage()
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCOutput1::ScreenTransition(short ScreenNo)
{
...
/*******************************************************************************************/
void GCOutput1::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
