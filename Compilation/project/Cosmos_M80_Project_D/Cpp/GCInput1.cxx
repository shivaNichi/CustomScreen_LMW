...
void GCIDeleteGCInput1( GBaseObject *pObject )
{
	GCInput1 *pPanel = (GCInput1*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCInput1( GBaseObject *pObject )
{
	GCInput1 *pPanel = new GCInput1;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCInput1;
...
#include "GCInput1.prc"

short GCInput1::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCInput1::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
...
long GCInput1::KEYACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCInput1::KEYACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
	...
	case GK_F1:
		...
		ScreenTransition(INPUT_2_SCREEN);
		break;
	case GK_F2:
		if(!(((lUParam & KEY_SHIFT) != KEY_SHIFT) && ((lUParam & KEY_SEC) != KEY_SEC)))
	    {
...
long GCInput1::KEYACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	pChild = GCSGetChild(GetGBaseObject(), KEYACTION);
...
long GCInput1::KEY_BACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(DIAGNOSIS_SCREEN);
	return TRUE;
}

long GCInput1::KEY_CIRCUITSOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetWarningMessage(UNDER_DEVELOPMENT_ERROR);
	return TRUE;
}

long GCInput1::KEY_CUT_O_METEROnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	sParentScreen = INPUT_1_SCREEN;
	ScreenTransition(CUT_O_METER_SCREEN);
	return TRUE;
...
long GCInput1::KEY_HISTORYOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetWarningMessage(UNDER_DEVELOPMENT_ERROR);
	return TRUE;
}

long GCInput1::KEY_INPUT2OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(INPUT_2_SCREEN);
	return TRUE;
}

long GCInput1::KEY_NEXTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(INPUT_2_SCREEN);
	return TRUE;
}

long GCInput1::KEY_OUTPUTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(OUTPUT_1_SCREEN);
	return TRUE;
}

long GCInput1::KEY_PLC_BITSOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	//ScreenTransition(BITS_1_SCREEN);
	return TRUE;
}

long GCInput1::KEY_VERSIONOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(VERSION_1_SCREEN);
	return TRUE;
}
...
/****************************************************************************************************/
void GCInput1::ClearWarningMessage()
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCInput1::ScreenTransition(short ScreenNo)
{
...
/*******************************************************************************************/
void GCInput1::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
