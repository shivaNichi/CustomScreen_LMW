...
long GCBITS4::KEYACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCBITS4::KEYACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
...
long GCBITS4::KEYACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCBITS4::KEY_BACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), BITS_3_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS4::KEY_DIAG_SCREENOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), DIAGNOSIS_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS4::KEY_NEXTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), BITS_5_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS4::KEY_SET_0OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetValueZero();
	return TRUE;
}

long GCBITS4::KEY_SET_1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetValueOne();
	return TRUE;
}

long GCBITS4::T1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 1;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS4::T2OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 2;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS4::T3OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 3;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS4::T4OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 4;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS4::T5OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 5;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS4::T6OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 6;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS4::T7OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 7;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS4::T8OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 8;
	SetCursor(Cursor_Pos);
	return TRUE;
...
/*******************************************************************************************/
void GCBITS4::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCBITS4::ClearWarningMessage()
{
	GBaseObject *pLbl;
	pLbl = GCSGetChild(GetGBaseObject(), MSGBOX);
...
void GCBITS4::DisplayBits()
{
	...
	melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), M_SEC_MPRM_SELECT_BIT, 
						M_SSEC_MP_SELECT_BIT(3), 0, &sRead6401Bits, T_LONG);
...
/****************************************************************************************************/
void GCBITS4::SetCursor(short cur_pos)
{
	GBaseObject *pTouchButton[13];
	//short position ;
