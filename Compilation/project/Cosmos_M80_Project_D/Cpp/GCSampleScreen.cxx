 ...
 *	<description>	:	コンストラクタ
 */
GCSampleScreenCosmos_M80_Project_D::GCSampleScreenCosmos_M80_Project_D()
{
	m_usType = GSCREEN;

	boScreenCosmos_M80_Project_D.usType = GSCREEN;
	boScreenCosmos_M80_Project_D.pSelf = this;
	boScreenCosmos_M80_Project_D.GCIMessageProcedure = &GCIBaseWindowMessageProcedure;
	boScreenCosmos_M80_Project_D.GCICallBackMessageProcedure = &GCIBaseWindowCallBackMessageProcedure;
	boScreenCosmos_M80_Project_D.pScreen = &boScreenCosmos_M80_Project_D;
	m_pSelf = &boScreenCosmos_M80_Project_D;
...
GCClassMP(GCSampleScreenCosmos_M80_Project_D)
GCInheritMP(GCScreen)

GCClassCBMP(GCSampleScreenCosmos_M80_Project_D)
GCEndClassCBMP()

#ifdef __cplusplus
extern "C" {
#endif
extern unsigned char cFillPatternsCosmos_M80_Project_D[][8];
extern unsigned char cLinePatternsCosmos_M80_Project_D[][8];
extern GResource *hResourceCosmos_M80_Project_D;
#ifdef __cplusplus
};
#endif


short GCSampleScreenCosmos_M80_Project_D::Create( GBaseObject *pParent )
{
	hResourceCosmos_M80_Project_D->ucMaxLocale = ucMaxLocale;
	...
	for( idx = 0; idx<NUM_FILL_PATS; idx++ ){ 
		GDDefineFillPattern( m_hDraw, idx, (char*)cFillPatternsCosmos_M80_Project_D[idx] );
	}
	for( idx = 0; idx<NUM_DASH_PATS; idx++ ){ 
		GDDefinePenDash( m_hDraw, idx+1, (char*)cLinePatternsCosmos_M80_Project_D[idx] );
	}
	...
	m_hResource = hResourceCosmos_M80_Project_D;
...
#ifdef NO_WINDOWS
GPropertyInfo* GCSampleScreenCosmos_M80_Project_D::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
#else//NO_WINDOWS
