...
{
	GCBITS1 *pPanel = (GCBITS1*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCBITS1( GBaseObject *pObject )
{
	GCBITS1 *pPanel = new GCBITS1;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCBITS1;
...
GPropertyInfo* GCBITS1::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
...
long GCBITS1::KEYACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCBITS1::KEYACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
...
long GCBITS1::KEYACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCBITS1::T1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 1;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS1::T2OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 2;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS1::T3OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 3;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS1::T4OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 4;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS1::T5OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 5;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS1::T6OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 6;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS1::T7OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 7;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS1::T8OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 8;
	SetCursor(Cursor_Pos);
	return TRUE;
...
/****************************************************************************************************/
void GCBITS1::SetCursor(short cur_pos)
{
...
long GCBITS1::KEY_BACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), DIAGNOSIS_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS1::KEY_DIAG_SCREENOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), DIAGNOSIS_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS1::KEY_NEXTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), BITS_2_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS1::KEY_SET_0OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetValueZero();
	return TRUE;
}

long GCBITS1::KEY_SET_1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetValueOne();
	return TRUE;
}
...
/*******************************************************************************************/
void GCBITS1::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCBITS1::ClearWarningMessage()
{
	GBaseObject *pLbl;
	pLbl = GCSGetChild(GetGBaseObject(), MSGBOX);
...
/*																									*/
/* Purpose - Used for read and Display the bit info on the buttons									*/
/****************************************************************************************************/
void GCBITS1::DisplayBits()
{
	...
	dwStatus = melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), M_SEC_MPRM_SELECT_BIT, 
						M_SSEC_MP_SELECT_BIT(0), 0, &sRead6401Bits, T_LONG);
