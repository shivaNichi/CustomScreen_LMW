...
{
	GCBackup *pPanel = (GCBackup*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCBackup( GBaseObject *pObject )
{
	GCBackup *pPanel = new GCBackup;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCBackup;
...
#include "GCBackup.prc"

short GCBackup::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCBackup::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
...
long GCBackup::GINPUTBOX00025OnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	return TRUE;
}

long GCBackup::GINPUTBOX00025OnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	return TRUE;
}

long GCBackup::GINPUTBOX00025OnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
	return TRUE;
}
