...
long GCBITS7::KEYACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCBITS7::KEYACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
	...
	switch(lLParam)
	{
		...
		case GK_F3:
					...
					break;
		case GK_F8:
					GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), BITS_8_SCREEN, 0), FALSE);
					break;
		case GK_F9:
		...
		case GK_F10:
					...
					GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), BITS_6_SCREEN, 0), FALSE);
					break;
...
long GCBITS7::KEYACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCBITS7::KEY_BACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), BITS_6_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS7::KEY_DIAG_SCREENOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), DIAGNOSIS_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS7::KEY_NEXTOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	GESetEvent(GECreateEventMessage(GM_SHOWPANEL, GCSGetScreen(GetGBaseObject()), BITS_8_SCREEN, 0), FALSE);
	return TRUE;
}

long GCBITS7::KEY_SET_0OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetValueZero();
	return TRUE;
}

long GCBITS7::KEY_SET_1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	SetValueOne();
	return TRUE;
}

long GCBITS7::T1OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 1;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS7::T2OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 2;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS7::T3OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 3;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS7::T4OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 4;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS7::T5OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 5;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS7::T6OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 6;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS7::T7OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 7;
	SetCursor(Cursor_Pos);
	return TRUE;
...
long GCBITS7::T8OnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	Cursor_Pos = 8;
	SetCursor(Cursor_Pos);
	return TRUE;
...
/*******************************************************************************************/
void GCBITS7::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCBITS7::ClearWarningMessage()
{
	GBaseObject *pLbl;
	pLbl = GCSGetChild(GetGBaseObject(), MSGBOX);
...
void GCBITS7::DisplayBits()
{
	...
	melGetData(0, (ADR_MACHINE(1)|ADR_BASE_SYSTEM|ADR_SYSTEM(1)|ADR_GROUND(0)), M_SEC_MPRM_SELECT_BIT, 
						M_SSEC_MP_SELECT_BIT(6), 0, &sRead6401Bits, T_LONG);
...
/****************************************************************************************************/
void GCBITS7::SetCursor(short cur_pos)
{
	GBaseObject *pTouchButton[13];
	//short position ;
