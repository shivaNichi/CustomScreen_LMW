...
{
	GCDuringmach *pPanel = (GCDuringmach*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCDuringmach( GBaseObject *pObject )
{
	GCDuringmach *pPanel = new GCDuringmach;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCDuringmach;
...
#include "GCDuringmach.prc"

short GCDuringmach::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCDuringmach::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
...
long GCDuringmach::CUT_O_METER_BUTTONOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	sParentScreen = DURING_MACHINING_SCREEN;
	ScreenTransition(CUT_O_METER_SCREEN);
	return TRUE;
}

long GCDuringmach::KEY_ACTIONOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
...
long GCDuringmach::KEY_ACTIONOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	GTCHAR inpBuff[10];
	char sData[10];
	...
	switch(lLParam)
	{
		...
		case GK_F5:
					...
					break;
		case GK_F6:	sParentScreen = DURING_MACHINING_SCREEN;
					ScreenTransition(CUT_O_METER_SCREEN);
					break;
		case GK_F7:
					DisableButtonName();
		...
		case GK_RETURN:ClearWarningMessage();
			switch(Cursor_Pos)
			{
				case 1:	sParentScreen = DURING_MACHINING_SCREEN;
						ScreenTransition(CUT_O_METER_SCREEN);
						break;
				/*case 2:ScreenTransition(OPERATOR_SETUP_SCREEN);
						break;*/
			}
			break;
		default:
...
long GCDuringmach::KEY_ACTIONOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
	GBaseObject *pChild;
	pChild = GCSGetChild(GetGBaseObject(), KEY_ACTION);
...
long GCDuringmach::KEY_BACKOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCDuringmach::KEY_CALC_WINDOWOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	if(!bCalcWindowOpened){
		DisableButtonName();
		bCalcWindowOpened = true;
...
long GCDuringmach::KEY_CUT_O_METEROnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	sParentScreen = DURING_MACHINING_SCREEN;
	ScreenTransition(CUT_O_METER_SCREEN);
	return TRUE;
...
long GCDuringmach::KEY_DIAGNOSISOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(DIAGNOSIS_SCREEN);
	return TRUE;
}

long GCDuringmach::KEY_MAINTENANCEOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(MAINTENANCE1_SCREEN);
	return TRUE;
}

long GCDuringmach::KEY_POST_MACHININGOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(POST_MACHINING_SCREEN);
	return TRUE;
}

long GCDuringmach::KEY_PRE_MACHININGOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(PRE_MACHINING_SCREEN);
	return TRUE;
}

long GCDuringmach::OP_SETUP_BUTTONOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	//ScreenTransition(OPERATOR_SETUP_SCREEN);
	return TRUE;
}
...
/****************************************************************************************************/
void GCDuringmach::SetCursor(short cur_pos)
{
	GBaseObject *pTouchButton[12];
	//short position ;

	pTouchButton[0] = GCSGetChild(GetGBaseObject(), CUT_O_METER_BUTTON);
	pTouchButton[1] = GCSGetChild(GetGBaseObject(), OP_SETUP_BUTTON);
...
/****************************************************************************************************/
void GCDuringmach::ClearWarningMessage()
{
	GBaseObject *pLbl;
...
/****************************************************************************************************/
void GCDuringmach::ScreenTransition(short ScreenNo)
{
	if(!bCalcWindowOpened){
...
/****************************************************************************************************/
void GCDuringmach::DisableButtonName()
{
...
/************************************************************************************/
long GCDuringmach::User(long lLParam, long lUParam)
{
	switch(lLParam)
	{
...
/************************************************************************************/
void GCDuringmach::EnableButtonName()
{
	GBaseObject *pKeyButton[10];
...
/****************************************************************************************************/
void GCDuringmach::ReadIconStatus()
{
	//ICON 1
...
/*******************************************************************************************/
void GCDuringmach::SetWarningMessage(int warnnum)
{
	GBaseObject *pLbl;
