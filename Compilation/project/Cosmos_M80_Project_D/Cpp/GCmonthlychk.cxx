...
void GCIDeleteGCmonthlychk( GBaseObject *pObject )
{
	GCmonthlychk *pPanel = (GCmonthlychk*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCmonthlychk( GBaseObject *pObject )
{
	GCmonthlychk *pPanel = new GCmonthlychk;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCmonthlychk;
...
#include "GCmonthlychk.prc"

short GCmonthlychk::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCmonthlychk::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
