...
{
	GCcycletime *pPanel = (GCcycletime*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCcycletime( GBaseObject *pObject )
{
	GCcycletime *pPanel = new GCcycletime;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCcycletime;
...
#include "GCcycletime.prc"

short GCcycletime::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCcycletime::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
