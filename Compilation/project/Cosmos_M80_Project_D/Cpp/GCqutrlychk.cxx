...
void GCIDeleteGCqutrlychk( GBaseObject *pObject )
{
	GCqutrlychk *pPanel = (GCqutrlychk*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCqutrlychk( GBaseObject *pObject )
{
	GCqutrlychk *pPanel = new GCqutrlychk;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCqutrlychk;
...
#include "GCqutrlychk.prc"

short GCqutrlychk::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCqutrlychk::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
