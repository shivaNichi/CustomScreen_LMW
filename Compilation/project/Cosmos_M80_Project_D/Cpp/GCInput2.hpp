...
public:
	...
	long KEYBACKOnClick(unsigned short usMessage, long lLParam, long lUParam );
	...
	long KEY_INPUT1OnClick(unsigned short usMessage, long lLParam, long lUParam );
	long KEY_NEXTOnClick(unsigned short usMessage, long lLParam, long lUParam );
	long KEY_OUTPUTOnClick(unsigned short usMessage, long lLParam, long lUParam );
