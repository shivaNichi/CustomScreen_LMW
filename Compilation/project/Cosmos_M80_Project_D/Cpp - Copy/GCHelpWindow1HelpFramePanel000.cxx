...
{
	GCHelpWindow1HelpFramePanel000 *pPanel = (GCHelpWindow1HelpFramePanel000*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCHelpWindow1HelpFramePanel000( GBaseObject *pObject )
{
	GCHelpWindow1HelpFramePanel000 *pPanel = new GCHelpWindow1HelpFramePanel000;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCHelpWindow1HelpFramePanel000;
 ...
 *	<description>	:	コンストラクタ
 */
GCHelpWindow1HelpFramePanel000::GCHelpWindow1HelpFramePanel000()
{
}
...
#include "GCHelpWindow1HelpFramePanel000.prc"

short GCHelpWindow1HelpFramePanel000::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCHelpWindow1HelpFramePanel000::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
