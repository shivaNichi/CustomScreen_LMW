...
public:
	...
	long MARGIN_INPUTOnCreate(unsigned short usMessage, long lLParam, long lUParam );
	long MARGIN_INPUTOnKeyPress(unsigned short usMessage, long lLParam, long lUParam );
	long MAX_LOAD_RECORDOnCreate(unsigned short usMessage, long lLParam, long lUParam );
	long MAX_LOAD_RECORDOnKeyPress(unsigned short usMessage, long lLParam, long lUParam );
	long P1XOnCreate(unsigned short usMessage, long lLParam, long lUParam );
	long P1XOnTimer(unsigned short usMessage, long lLParam, long lUParam );
