...
{
	GCMCCondsel *pPanel = (GCMCCondsel*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCMCCondsel( GBaseObject *pObject )
{
	GCMCCondsel *pPanel = new GCMCCondsel;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCMCCondsel;
...
#include "GCMCCondsel.prc"

short GCMCCondsel::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCMCCondsel::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
