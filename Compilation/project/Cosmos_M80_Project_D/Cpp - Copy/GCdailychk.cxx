...
{
	GCdailychk *pPanel = (GCdailychk*)pObject->pSelf;
	delete pPanel;
	pObject->pSelf = NULL;
}	
short GCINewGCdailychk( GBaseObject *pObject )
{
	GCdailychk *pPanel = new GCdailychk;
	if( pPanel == NULL ){
		return FALSE;
	}
	...
	pObject->GCIDeleteObject = &GCIDeleteGCdailychk;
...
#include "GCdailychk.prc"

short GCdailychk::CreateChildren( )
{
	GBaseObject *pChild;
...
GPropertyInfo* GCdailychk::GetPropertyInfo(const GBaseWindowProperty* pImport, unsigned short* pGPropertyInfoCnt)
{
