...
static const GSVFramePropertyEx pGHelpFramepProperty[1] =
{
	...
	{{{{{GHELPWINDOW1HELPFRAME, GCHelpWindow1::HELPFRAME, 8, 16, 597, 359, GW_STYLE_ENABLE|GW_STYLE_VISIBLE, (GFocusInformation*)&pHelpFrameFocusInformation},{{NO_DRAW, 0, 0}, 0}, 100, 100}}}}
};
