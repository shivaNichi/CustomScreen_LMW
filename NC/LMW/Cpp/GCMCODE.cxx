...
long GCMCODE::DATAOnKeyPress(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCMCODE::DATAOnTimer(unsigned short usMessage, long lLParam, long lUParam)
{
...
long GCMCODE::HIST_TABLEOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
	return TRUE;
}

//void GCMCODE::UpdateStatus()
//{
//	GBaseObject *pTbl;
...
//	}
//}
bool GCMCODE::Readstatus(char *cInputData)
{
	char prgststatus[20];
	STRINGTYPE str1;
	str1.lBuffSize=20;
...
long GCMCODE::DATAOnCreate(unsigned short usMessage, long lLParam, long lUParam)
{
...
void GCMCODE::Fetchdata(long sOffset)
{
	...
	long countsize=0;
		...
		char sDestFile[] = "M01:\\PRG\\MMACRO\\MCODE.CSV";
...
//char* GCMCODE::Fetchcomment(char *cAdrss)
//{
//
//	DWORD dwStatus;
//	FS_STAT stat;
...
//
//}
//void GCMCODE::LoadHtmlFile(char *cAdrss)
//{
...
long GCMCODE::HOMEBTNOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition(EOS_SCREEN);
	return TRUE;
}

long GCMCODE::BTNGCODEOnClick(unsigned short usMessage, long lLParam, long lUParam)
{
	ScreenTransition( GCODE_SCREEN);
	return TRUE;
}
